...
Battlelogium is a [Battlelog](http://battlelog.battlefield.com/) client that wraps Battlelog, Origin, and Battlefield 3, 4 and Hardline into one neat package. It enables Steam features such as the overlay and In-Home Streaming for Battlefield 3, Battlefied 4, and Battlefield Hardline.
...
* Steam Overlay support for Battlefield 3, **Battlefield 4 and Battlefield Hardline**_*_
* Steam **In-Home Streaming**** for Battlefield 3, 4, and Hardline
