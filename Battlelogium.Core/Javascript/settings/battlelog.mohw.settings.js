        ...
        if (!$('#battlelogSettings').length) {
            var checkExist = setInterval(function () {
                if ($('.profile-edit-gravatar-info').length) {
                    ...
                    section.html('<div class="label"> <label>Battlelogium Settings</label> </div> <div> <p>Edit Battlelogium Settings</p><br><a onclick="app.opensettings()" href="#" style="margin-right: 16px;">Edit Program Settings</a><a onclick="app.clearcache()" href="#">Clear Cache and Cookies</a><a onclick="app.forceupdate()" href="#">Force Update</a> </div><div style="clear:both;float:none;"></div>')
